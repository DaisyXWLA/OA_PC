      ...
      <div style="height: 800px;">
        ...
        <div class="h-panel-body">
          ...
          <div style="width:85%;margin: 0 auto;">
            <Table ref="table" :datas="datas" :border="true" :loading="isLoading">
...
export default {
  ...
  methods: {
    ...
    getData(reload = false) {
      ...
      setTimeout(() => {
        (this.datas = [
          { name: '张一', time: '2019-06-09', state: '已审批', type: '浪子回头悬崖勒马重新做人' },
          { name: '张二', time: '2019-06-10', state: '未通过', type: '浪子回头悬崖勒马重新做人' },
          { name: '张三', time: '2019-06-11', state: '已审批', type: '浪子回头悬崖勒马重新做人' },
          { name: '张四', time: '2019-06-12', state: '待审批', type: '浪子回头悬崖勒马重新做人' }
        ]),
