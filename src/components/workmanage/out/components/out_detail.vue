                  ...
                  <Cell>
                    ...
                    <div class="hed">
                      <Form class="info-basic" :label-width="90" mode="twocolumn" readonly>
                        <FormItem label="外出主题:">{{data.da1}}</FormItem>
                        <FormItem label="外出天数:">{{data.da6}}</FormItem>
                        <FormItem label="外出地点:">{{data.da2}}</FormItem>
                        <FormItem label="部门:">{{data.da7}}</FormItem>
                        <FormItem label="外出同行人:">{{data.da3}}</FormItem>
                        <FormItem label="申请人:">{{data.da8}}</FormItem>
                        <FormItem label="外出时间段:">{{data.da4}}</FormItem>
                        <FormItem label="申请日期:">{{data.da9}}</FormItem>
                        <FormItem label="外出事由:">{{data.da5}}</FormItem>
                      </Form>
                    </div>
                  </Cell>
                  <Cell>
