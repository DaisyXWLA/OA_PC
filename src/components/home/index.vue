...
@media screen and (max-width: 1366px) {
  ...
  .project-progress-statistic {
    font-size: 14px !important;
  }
  .project-progress-calculate {
    p {
      font-size: 16px !important;
    }
  }
    ...
    <Row :space="8">
        ...
        <div class="h-panel">
          <div class="h-panel-body">
            <Row>
              <!-- <Cell :lg="2" :xl="2">
                <div class="real-time">
                  <span style="font-size:30px;dispaly:inline-block;margin-top:10px;">{{realTime}}</span>
                  <p>
                    <span>{{nowDate}}</span>
                    <span>{{nowWeek}}</span>
                  </p>
              ...
              <Cell :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
                <div class="text-left">
                  <iframe
                    ...
                    height="80"
                    width="600"
                    src="http://i.tianqi.com/index.php?c=code&a=getcode&id=38&h=60&w=400"
                  ></iframe>
                </div>
              </Cell>
              <Cell :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
      ...
      <Cell :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
        <div class="h-panel pro-statistics">
          <div class="h-panel-bar">
            <Row>
              <Cell :width="12">
                <span class="module-title">项目统计</span>
              </Cell>
          ...
          <div class="h-panel-body" style="height:300px">
            <Row type="flex">
              <Cell :width="10">
                ...
                <Row type="flex" justify="space-around" class="project-progress-calculate">
              ...
              <Cell :width="14">
                <div style="margin-top:40px;">
                  <Row>
                    <Cell :width="18">
                      <div class="project-progress" v-font="20">
                        <p slot="title">
                    ...
                    <Cell :width="6">
                      <div class="project-progress-statistic" v-font="16">
                        <p>
                          总任务：
      ...
      <Cell :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
        <div class="h-panel announcement">
          ...
          <div class="h-panel-body" style="height:300px">
            <h3 style="text-align: center;font-size:24px;" class="announcement-title">{{announcement.title}}</h3>
      ...
      <Cell :xs="24" :sm="24" :md="24" :lg="16" :xl="16">
        <div class="h-panel">
          <div class="h-panel-bar">
            <span class="module-title">任务信息</span>
          </div>
          <div class="home-part-body" v-font="18">
            <Table :datas="taskInfo" class="task-table">
              <TableItem :width="80" title="序号" align="center" fixed="left">
              ...
              <TableItem :width="70" title="执行人" align="left" fixed="left">
                <template slot-scope="{data}">
                  <div v-if="data.status==0">
              ...
              <TableItem :width="80" prop="task" title="任务状态" align="center" fixed="right">
                <template slot-scope="{data}">
                  <div v-if="data.status==0">
      ...
      <Cell :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
        <div class="h-panel">
          <div class="h-panel-bar">
            <span class="module-title">待办业务</span>
          </div>
          <div class="home-part-body" v-font="18">
    ...
    getData() {
      ...
      R.ProjectTask.projectNameAndIdList(taskList.dispose(this.taskModel)).then(resp => {
        if (resp.ok) {
          ...
          //项目统计
          this.showTaskInfoList.projectInfo = resp.body[0].key;
          R.showTaskInfo.showTaskInfo(showTaskInfoModel.dispose(this.showTaskInfoList)).then(resp => {
            if (resp.ok) {
              this.data = resp.body;
            }
