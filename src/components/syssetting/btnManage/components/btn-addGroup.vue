<template>
  <Modal v-model="addBtnGroup" :hasCloseIcon="hasCloseIcon" :hasDivider="hasDivider" :middle="true" :closeOnMask="closeOnMask">
    <div slot="header" class="title">新增分组<i class="h-icon-close" @click="close"></i></div>

    <div :labelPosition="labelPosition">
      <Form ref="form" :model="btnGroupList" :label-width="110" :top="0.2" :rules="validationRules">
