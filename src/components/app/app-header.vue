...
<template>
  <div class="app-header">
    <div style="width:50px;float:left;"><Button :icon="siderCollapsed ? 'icon-align-right':'icon-align-left'" size="l" noBorder class="font20 side-btn" @click="siderCollapsed=!siderCollapsed"></Button></div>
